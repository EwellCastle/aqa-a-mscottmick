...
def CountPlants(Field):
    ...
    if NumberOfPlants == 1:
        ...
        print('There are', NumberOfPlants, 'plants growing', FIELDLENGTH, FIELDWIDTH)
        CELLS=FIELDLENGTH * FIELDWIDTH
        print("Cells",CELLS)
        percentage=NumberOfPlants/CELLS*100
        print("percentage:",percentage)
        a=round(percentage,0) #rounding
        b=int(a) #cast to integer
        print("percentage", b)
